...
{ 3, "DamageTaken", 1, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Damage Taken", data = {
	...
	{ label = "Taken As",
		...
		{ format = "{2:output:PhysicalTakenDamage}", 
			...
			{ modName = { "PhysicalDamageTakenAsLightning", "PhysicalDamageTakenAsCold", "PhysicalDamageTakenAsFire", "PhysicalDamageTakenAsChaos" } } 
		},
		{ format = "{2:output:LightningTakenDamage}",
			{ breakdown = "LightningTakenDamage" }, 
			{ modName = { "LightningDamageTakenAsPhysical", "LightningDamageTakenAsCold", "LightningDamageTakenAsFire", "LightningDamageTakenAsChaos", "ElementalDamageTakenAsPhysical", "ElementalDamageTakenAsChaos" } }
		},
		{ format = "{2:output:ColdTakenDamage}",
			{ breakdown = "ColdTakenDamage" }, 
			{ modName = { "ColdDamageTakenAsPhysical", "ColdDamageTakenAsLightning", "ColdDamageTakenAsFire", "ColdDamageTakenAsChaos", "ElementalDamageTakenAsPhysical", "ElementalDamageTakenAsChaos" } }
		},
		{ format = "{2:output:FireTakenDamage}", 
			{ breakdown = "FireTakenDamage" }, 
			{ modName = { "FireDamageTakenAsPhysical", "FireDamageTakenAsLightning", "FireDamageDamageTakenAsCold", "FireDamageTakenAsChaos", "ElementalDamageTakenAsPhysical", "ElementalDamageTakenAsChaos" }  } 
		},
		{ format = "{2:output:ChaosTakenDamage}",
			{ breakdown = "ChaosTakenDamage" }, 
			{ modName = { "ChaosDamageTakenAsPhysical", "ChaosDamageTakenAsLightning", "ChaosDamageTakenAsCold", "ChaosDamageTakenAsFire" } }
		},
	},
