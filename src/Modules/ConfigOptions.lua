...
return {
	...
	{ var = "EHPUnluckyWorstOf", type = "list", label = "EHP calc unlucky:", tooltip = "LL", list = {{val=1,label="Average"},{val=2,label="Unlucky"},{val=4,label="Very Unlucky"}} },
	...
	{ var = "enemySpeed", type = "integer", label = "Enemy Skill use time:" },
