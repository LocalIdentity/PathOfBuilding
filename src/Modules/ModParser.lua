...
local specialModList = {
	...
	["(%d+)%% of damage from hits is taken from your spectres' life before you"] = function(num) return { mod("DamageTakenWhenHit", "MORE", -num, { type = "StatThreshold", stat = "ActiveSpectreLimit", threshold = 1 }) } end,
