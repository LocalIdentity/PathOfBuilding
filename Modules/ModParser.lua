...
local modFlagList = {
	...
	["with melee attacks"] = { flags = bor(ModFlag.Melee, ModFlag.Attack) },
	...
	["with hits and ailments"] = { tag = { type = "ModFlagOr", modFlags = bor(ModFlag.Hit, ModFlag.Ailment) } },
	...
	["of curse aura skills"] = { keywordFlags = bor(KeywordFlag.Curse, KeywordFlag.Aura, KeywordFlag.MatchAll) },
