...
{ 3, "Dot", 1, "Skill Damage over Time", colorCodes.OFFENCE, {
	...
	{ label = "PvP Damage over Time", flag = "PvpDot", { format = "{1:output:PvpTotalDot}", { breakdown = "PvpTotalDot" }, }, },
	{ label = "Mana Cost", { format = "{0:output:ManaCost}", { breakdown = "ManaCost" }, { modName = "ManaCost", cfg = "skill" }, }, },
} },
...
{ 1, "Bleed", 1, "Bleed", colorCodes.OFFENCE, {
	...
	{ label = "PvP Bleed DPS", flag = "PvpBleed", { format = "{1:output:PvpBleedDPS}", { breakdown = "PvpBleedDPS" }, { breakdown = "MainHand.PvpBleedDPS" }, { breakdown = "OffHand.PvpBleedDPS" }, }, },
...
{ 1, "Impale", 1, "Impale", colorCodes.OFFENCE, {
	...
	{ label = "PvP Impale DPS", flag = "PvpImpaleNotAverage", { format = "{1:output:PvpImpaleDPS}", { breakdown = "PvpImpaleDPS" }, }, },
	{ label = "Impale Damage", flag = "impale", flag = "showAverage", { format = "{1:output:ImpaleDPS}", { breakdown = "ImpaleDPS" }, }, },
	{ label = "PvP Impale Damage", flag = "PvpImpaleShowAverage", { format = "{1:output:PvpImpaleDPS}", { breakdown = "PvpImpaleDPS" }, }, },
} },
{ 1, "Poison", 1, "Poison", colorCodes.OFFENCE, {
	...
	{ label = "PvP Poison DPS", flag = "PvpPoison", { format = "{1:output:PvpPoisonDPS}", 
		{ breakdown = "PvpPoisonDPS" }, 
		{ breakdown = "MainHand.PvpPoisonDPS" },
		{ breakdown = "OffHand.PvpPoisonDPS" },
	}, },
	...
	{ label = "PvP Dmg. per Poison", flag = "PvpPoison", { format = "{1:output:PvpPoisonDamage}", 
		{ breakdown = "MainHand.PvpPoisonDamage" }, 
		{ breakdown = "OffHand.PvpPoisonDamage" }, 
...
{ 1, "Ignite", 1, "Ignite", colorCodes.OFFENCE, {	
	...
	{ label = "PvP Ignite DPS", flag = "PvpIgnite", { format = "{1:output:PvpIgniteDPS}", 
		{ breakdown = "PvpIgniteDPS" }, 
		{ breakdown = "MainHand.PvpIgniteDPS" },
		{ breakdown = "OffHand.PvpIgniteDPS" },
		{ modName = { "IgniteBurnRate" }, cfg = "skill" }, 
	}, },
	...
	{ label = "PvP Dmg. per Ignite", flag = "PvpIgnite", flag = "igniteCanStack", { format = "{1:output:PvpIgniteDamage}",
		{ breakdown = "MainHand.PvpIgniteDamage" },
		{ breakdown = "OffHand.PvpIgniteDamage" },
...
{ 1, "Decay", 1, "Decay", colorCodes.OFFENCE, {
	...
	{ label = "PvP Decay DPS", flag = "PvpDecay", { format = "{1:output:PvpDecayDPS}", 
